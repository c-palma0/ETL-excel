...
<?php $results = mysqli_query($db, "SELECT * FROM tbl_topes"); 
$resultado = $results -> num_rows;
//topes prueba no terminada
?>
<div class="etl1">

<?php if ($resultado):?>

	<h3>Topes <img data-toggle="modal" data-target="#exampleModalCenter" src="wi2.png"></h3>
 ...
 <tbody>
	...
	while ($row = mysqli_fetch_array($results)): ?>
		...
		<form method="POST" action="server.php">
			...
			<td><?php echo $row['material'];?><input style="display:none;" type="text" name="id_ca" value="<?php echo $row['material'];?>"></td>	
