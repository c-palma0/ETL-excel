...
<?php $results = mysqli_query($db, "SELECT * FROM tbl_multas"); 
...
<?php if ($resultado):?>
	...
	<h3>&nbsp;&nbsp;Multas&nbsp;<img data-toggle="modal" data-target="#exampleModalCenter" src="wi2.png"></h3>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br>
        -El formato de hora debe ser hh:mm. (ejemplo: 20:08)
      </div>
