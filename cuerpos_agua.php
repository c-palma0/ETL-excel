...
<?php $results = mysqli_query($db, "SELECT t.coord_x , t.coord_y, t.id, t.area, c.tipo, t.id_ca FROM tbl_cuerpos_de_agua as t join ct_cuerpos_agua as c on t.id_ca= c.id"); 
